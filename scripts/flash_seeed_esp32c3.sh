...
# =========================================================
# Flash script for Seeed ESP32-C3
# - Syncs the Seeed build folder from server
...
REMOTE_BUILD="$REMOTE_BASE/build-seeed"
LOCAL_BUILD="$LOCAL_BASE/seeed"
CHIP="esp32c3"
