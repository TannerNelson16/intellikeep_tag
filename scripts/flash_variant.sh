...
# =========================================================
# Flash script for a fixed ESP32-C3 build variant
# - Syncs one matching build folder from server
# - Uses ESP-IDF-generated flash args when available
# - Falls back to manual offsets if needed
# =========================================================

VARIANT="${1:?Usage: $0 <variant> [serial-port]}"
PORT="${2:-/dev/ttyACM0}"
...
REMOTE_BUILD="$REMOTE_BASE/build-$VARIANT"
LOCAL_BUILD="$LOCAL_BASE/$VARIANT"
CHIP="esp32c3"
