...
# =========================================================
# Flash script for production tag
# - Syncs the production build folder from server
...
REMOTE_BUILD="$REMOTE_BASE/build-production"
LOCAL_BUILD="$LOCAL_BASE/production"
CHIP="esp32c3"
